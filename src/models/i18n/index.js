    ...
    switch (this.lng) {
      case 'en':
        return {
          ...
          year: 'Year',
          layer: 'Type of Data',
          desc: 'Describe a problem. If our data is incorrect please provide links to verify it',
          ref: 'Reference',
          ToS: 'I agree to the Privacy Policy',
          ToSlink: 'Privacy Policy',
          button: 'Bug report',
      ...
      default:
        return {
          ...
          year: 'Год',
          layer: 'Тип данных',
          desc: 'Опишите ситуацию. Если вы заметили несоответствие данных, предоставьте пожалуйста ссылки на источники.',
          ref: 'Ссылка на источник',
          ToS: 'Я принимаю условия',
          ToSlink: 'Пользовательского соглашения',
          button: 'Сообщить',
