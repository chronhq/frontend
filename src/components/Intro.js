  ...
  render() {
    ...
    return (
      <div className='overlay'>
        ...
        <div style={this.state.whichSlide === 3 ? highlightDiv : null} className='overlay-survey' />
